<template>
    ...
    <div class=" max-h-[850px] overflow-y-auto overflow-x-hidden">
          <div v-if="active === 0">
            ...
            <UnAssigned @totalDataLength="handleTotalDataLength"/>
                
          </div>    
          <div v-else-if="active === 1">
            <Assigned @totalDataLength="handleAssignedLength"/>
          </div>
          <div v-else-if="active === 2">
            <Completed @totalDataLength="handleCompletedLength"/>
          </div>
        </div>
        </div>
</template>
...
const allItems = [
    { text: "Unassigned", link: "#", number: `${ 0}` },
    { text: "Assigned", link: "#", number: `${ 0}` },
    { text: "Completed", link: "#", number: `${ 0}` },
];
